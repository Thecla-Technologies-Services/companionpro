...
/* Smooth-scroll helper — offsets for fixed 68px navbar */
...
function WaitlistModal({ onClose }) {
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(5,12,40,0.82)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem", backdropFilter: "blur(8px)" }}>
      <div onClick={(e) => e.stopPropagation()} style={{ background: "white", borderRadius: "1.75rem", padding: "2.75rem", maxWidth: "500px", width: "100%", position: "relative", boxShadow: "0 30px 80px rgba(0,0,0,0.35)" }}>
        ...
        {!submitted ? (
          <>
            <div style={{ marginBottom: "1.75rem" }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "1.9rem", color: "#0f1e5a", marginBottom: "0.5rem", fontWeight: 800 }}>Join the Waitlist</h2>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "0.6rem" }}>
                {[["family", "👨‍👩‍👧 Family"], ["companion", "🤝 Companion Pro"], ["both", "💙 Both"]].map(([v, l]) => (
                  <button key={v} onClick={() => setRole(v)}
                    style={{ padding: "0.75rem 0.4rem", borderRadius: "0.75rem", border: `2px solid ${role === v ? "#2563eb" : "#e5eaf5"}`, background: role === v ? "#eff6ff" : "white", color: role === v ? "#2563eb" : "#888", fontSize: "0.78rem", cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontWeight: 600 }}>
                    {l}
                  </button>
                ))}
              </div>
          ...
          <div style={{ textAlign: "center", padding: "1.5rem 0" }}>
            ...
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "1.9rem", color: "#0f1e5a", marginBottom: "0.75rem", fontWeight: 800 }}>You're on the list!</h2>
  ...
  return (
    <>
      <style>{`
        ...
        /* ── Hard reset — kills every browser default margin/padding that causes side gaps ── */
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Nav links — rendered as buttons, styled as links */
      ...
      <div style={{ fontFamily: "'DM Sans',sans-serif", background: "#f5f8ff", color: "#0f1e5a", minHeight: "100vh", width: "100%", overflowX: "hidden", margin: 0, padding: 0 }}>
        ...
        <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 200, background: "rgba(8,15,50,0.97)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(255,255,255,0.06)", width: "100%" }}>
          <div style={{ width: "100%", padding: "0 3rem", height: "68px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>

            {/* LEFT — Companioo logo: white/transparent on dark nav */}
            <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
              style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: "0.85rem", padding: 0 }}>
              {/* mixBlendMode:screen + brightness filter makes jpeg logo appear white on dark bg */}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "2.5rem" }}>
              ...
              <button className="btn-primary" style={{ padding: "0.55rem 1.4rem", fontSize: "0.82rem" }} onClick={() => setModal(true)}>
                🚀 Join Waitlist
              </button>
            </div>
          </div>
        ...
        {/* ══════════════════════════════════════
            HERO — two-column split, full-bleed
        ══════════════════════════════════════ */}
        <section style={{ position: "relative", height: "100vh", minHeight: "740px", overflow: "hidden", width: "100%" }}>
          {slides.map((s, i) => (
          ...
          {/* Two-column grid — fills 100% of viewport */}
          <div style={{ position: "absolute", inset: 0, zIndex: 3, display: "grid", gridTemplateColumns: "55% 45%", alignItems: "center", paddingTop: "68px" }}>
            ...
            <div style={{ padding: "0 3rem 0 4rem" }}>
              <div className="fade-in" key={slide}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "1.5rem" }}>
                  <div style={{ width: "140px", height: "140px", borderRadius: "8px", overflow: "hidden", flexShrink: 0 }}>
                    <img src={COMPANIOO_LOGO} alt="CompanionPro" style={{ width: "100%", height: "100%", objectFit: "contain"}} />
                  </div>
                ...
                <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(2.5rem,4.5vw,4.2rem)", fontWeight: 900, color: "white", lineHeight: 1.1, marginBottom: "1.5rem", textShadow: "0 4px 30px rgba(0,0,0,0.4)" }}>
                  {slides[slide].heading}
                </h1>
                <p style={{ fontFamily: "'DM Sans',sans-serif", color: "rgba(255,255,255,0.82)", fontSize: "1.12rem", lineHeight: 1.8, marginBottom: "2.25rem", maxWidth: "480px" }}>
                  {slides[slide].sub}
                </p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem", padding: "0 3rem 0 2rem", alignSelf: "center" }}>
          ...
          {/* Slide dots */}
          <div style={{ position: "absolute", bottom: "4.5rem", left: "4rem", zIndex: 3, display: "flex", gap: "0.6rem", alignItems: "center" }}>
          ...
          {/* Ticker — zero padding on left/right edges */}
          <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, zIndex: 3, background: "rgba(15,30,90,0.72)", backdropFilter: "blur(10px)", padding: "0.85rem 4rem", display: "flex", alignItems: "center", gap: "3rem", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <section id="about" style={{ background: "white", overflow: "hidden", width: "100%" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "640px" }}>
            ...
            <div style={{ padding: "6rem 4rem", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(2rem,2.8vw,2.8rem)", fontWeight: 900, color: "#0f1e5a", lineHeight: 1.15, marginBottom: "1.5rem" }}>
        ...
        <section id="how-it-works" style={{ background: "#f0f5ff", width: "100%" }}>
          <div style={{ paddingTop: "5rem", paddingBottom: "3rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", padding: "0 3rem" }}>
              <div>
                <span className="badge-pill" style={{ marginBottom: "1rem", display: "block" }}>How It Works</span>
                <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(2rem,3vw,2.8rem)", fontWeight: 900, color: "#0f1e5a", lineHeight: 1.15 }}>Simple, caring,<br />and personal</h2>
              </div>
          ...
          <div style={{ paddingTop: "3rem", paddingBottom: "5rem", paddingLeft: "3rem" }}>
        ...
        <section id="services" style={{ background: "white", overflow: "hidden", width: "100%" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr" }}>
            <div style={{ background: "linear-gradient(180deg,#0f1e5a 0%,#2563eb 100%)", padding: "6rem 3rem", display: "flex", flexDirection: "column", justifyContent: "space-between", position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "2.2rem", fontWeight: 900, color: "white", lineHeight: 1.2, marginBottom: "1.5rem" }}>Our companions can help with</h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", borderLeft: "1px solid #e8eeff" }}>
              {services.map((s, i) => (
        ...
        <section ref={statsRef} style={{ background: "linear-gradient(110deg,#080f32 0%,#0f1e5a 40%,#1d4ed8 100%)", width: "100%", overflow: "hidden", position: "relative" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", width: "100%" }}>
            {[[counts[0] + "+", "Seniors on the waitlist", "💙"], [counts[1] + "%", "Family satisfaction rate", "⭐"], ["24/7", "Support availability", "🕐"], ["100%", "DBS-verified companions", "🔒"]].map(([n, l, icon], i) => (
              <div key={i} style={{ padding: "4rem 3.5rem", borderRight: i < 3 ? "1px solid rgba(255,255,255,0.1)" : "none" }}>
        ...
        {/* ══════════════════════════════════════
            COMPANION PRO — id="companion-pro"
        ══════════════════════════════════════ */}
        ...
        <section style={{ background: "linear-gradient(105deg,#0a1230 0%,#0f1e5a 60%,#1d4ed8 100%)", width: "100%", position: "relative", overflow: "hidden", paddingTop: "7rem", paddingBottom: "7rem" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center", padding: "0 4rem" }}>
            <div>
              <div style={{ width: "140px", height: "140px", borderRadius: "10px", overflow: "hidden", marginBottom: "1.75rem" }}>
                <img src={COMPANIOO_LOGO} alt="CompanionPro" style={{ width: "100%", height: "100%", objectFit: "contain"}} />
              </div>
              <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(2.2rem,3.5vw,3.2rem)", fontWeight: 900, color: "white", lineHeight: 1.1, marginBottom: "1.25rem" }}>The app is<br />launching soon.</h2>
            ...
            <div style={{ background: "rgba(255,255,255,0.07)", backdropFilter: "blur(12px)", borderRadius: "1.75rem", padding: "3rem", border: "1px solid rgba(255,255,255,0.12)" }}>
        ...
        <footer style={{ background: "#060c28", width: "100%", paddingTop: "5rem", paddingBottom: "2.5rem", color: "white" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2.5fr 1fr 1fr 1.5fr", gap: "3rem", marginBottom: "4rem", paddingBottom: "3rem", paddingLeft: "4rem", paddingRight: "4rem", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem", paddingLeft: "4rem", paddingRight: "4rem" }}>
